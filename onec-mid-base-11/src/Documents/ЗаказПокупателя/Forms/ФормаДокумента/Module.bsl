...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// ++Сапегин Добавление реквизитов на форму 16.05.2025
	Если Элементы.Найти("ЭлементКЛ_КонтактноеЛицо") = Неопределено Тогда
		
		ТипРеквизита = Новый ОписаниеТипов("СправочникСсылка.КЛ_КонтактныеЛица");
		
		ДобавляемыеРеквизиты = Новый Массив;
		РеквизитФормы = Новый РеквизитФормы("РеквизитКЛ_КонтактноеЛицо", ТипРеквизита, "", "Контактное лицо");
		ДобавляемыеРеквизиты.Добавить(РеквизитФормы);
		
		ИзменитьРеквизиты(ДобавляемыеРеквизиты);
		
		ПолеВвода = Элементы.Добавить("ЭлементКЛ_КонтактноеЛицо", Тип("ПолеФормы"), Элементы.ГруппаШапкаПраво);
		ПолеВвода.Вид = ВидПоляФормы.ПолеВвода;
		ПолеВвода.ПутьКДанным = "Объект.КЛ_КонтактноеЛицо";
	КонецЕсли;
	
	// добавляем новую группу и в неё 1 реквизит и 1 команду 
	Если Элементы.Найти("ЭлементКЛ_СогласованнаяСкидка") = Неопределено Тогда		
		...
		ДобавляемыеРеквизиты = Новый Массив;
		РеквизитФормы = Новый РеквизитФормы("РеквизитКЛ_СогласованнаяСкидка", ТипРеквизита, "", "Согласованная Скидка");
		ДобавляемыеРеквизиты.Добавить(РеквизитФормы);
		
		ИзменитьРеквизиты(ДобавляемыеРеквизиты);
		
		ПолеВвода = Элементы.Добавить("ЭлементКЛ_СогласованнаяСкидка", Тип("ПолеФормы"), Группа);
		ПолеВвода.Вид = ВидПоляФормы.ПолеВвода;
...
// ++Сапегин Добавление обработчика к элементу согласованная скидка на форму 16.05.2025
&НаКлиенте
...
// Добавляем обработчик по пересчету суммы документа
&НаКлиенте
...
//чтобы избежать дублирования кода отдельная процедура.
&НаКлиенте
